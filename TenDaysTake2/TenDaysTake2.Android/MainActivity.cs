...
namespace TenDaysTake2.Droid
{
    [Activity(Label = "TenDaysTake2", Icon = "@mipmap/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
